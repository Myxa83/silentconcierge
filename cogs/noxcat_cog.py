...
class NoxCatCog(commands.Cog):
    ...
    def _bath_reply() -> str:
        return random.choice([
            ...
            "Даністіане, залиште Ноксу його лохматість. Без неї він втратить половину авторитету й приблизно третину об'єму.",
        ])
    ...
    def _feeding_reply() -> str:
        return random.choice([
            ...
            "Нокс уже не нагодований. Він стратегічно забезпечений провіантом на кілька кампаній.",
            "Наступну тарілку прибрати. Темрява має бути загадковою, а не ситою до нерухомості.",
            "Даністіане, припиніть відгодівлю. Галя любить пузатеньких, але навіть у її терпіння є архітектурні межі.",
        ])
...
",
            ...
            "Ви підозріло розумний для істоти, яку Даністіан регулярно намагається вимити.",
        ])

    @staticmethod
    def _bot_closing_reply() -> str:
        return random.choice([
            "Все, Ноксе. Я тебе зловив і поніс до Галі на клавіатуру. Вона любить пузатеньких і лохматих. Далі розбирайтесь самі.",
            "Так, усе. Дипломатичну місію завершено. Нокса під пахву і до Галі на клавіатуру. Вона має слабкість до пузатеньких лохматиків.",
            "На цьому ботячу раду оголошую закритою. Ноксе, ходімо. Галя ще не знає, але в неї вже з'явився лохматий прес-пап'є для клавіатури.",
            "Досить розумних розмов. Нокса конфісковано Тихою Затокою й транспортовано до Галі. Причина: надмірна лохматість і підозріло зручний живіт.",
            "Все. Нокса забираю. Галя любить пузатеньких і лохматеньких, а я поважаю природний порядок речей. До зустрічі після карантину.",
        ])
