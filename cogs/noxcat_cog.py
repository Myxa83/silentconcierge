...
class NoxCatCog(commands.Cog):
    ...
    def _bot_closing_reply() -> str:
        return random.choice([
            ...
            "Все. Нокса конфісковано. Несу Мусі тискати, бо занадто пухкенький, занадто лохматий і явно сам напросився.",
            "Досить філософії. Ноксе, під пахву й до Галі. Вона полюбляє пухкеньких лохматиків, а я не сперечаюся з природним порядком речей.",
